...
This repo contains a sample project for Scala with sbt and below you can
...
Any **sbt** project might be used as a programming task as we support any
testing framework supported by it.
